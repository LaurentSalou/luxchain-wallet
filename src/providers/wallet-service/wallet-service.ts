...
export class WalletServiceProvider {
    ...
    getMstIcons() {
        return ['ETP', 'MVS.ZGC', 'MVS.ZDC', 'CSD.CSD', 'PARCELX.GPX', 'PARCELX.TEST', 'SDG', 'META', 'MVS.HUG', 'RIGHTBTC.RT', 'TIPLR.TPC', 'LUXCHAIN.LXR'];
    }
    ...
    postAssetInfo(asset) {
        return this.http.post("http://biapi-test.luxsens.com/api/mvs/mit", asset);
    }

    getAssetInfo(symbol) {
        return this.http.get("http://biapi-test.luxsens.com/api/mvs/mit/" + symbol)
    }
